...
function page2anim(){
  let mydiv = document.getElementById('secondline');
  let mydivhtml = document.getElementById('secondline').innerHTML;
  let myarr = mydivhtml.split(' ');
  let newarr = myarr.map((element,index)=>`<span id='number${index}' class='animated'>${element}</span>`);
  mydiv.innerHTML = newarr.join('\n')
    gsap.to(`#secondline>span`,{
      color:'white',
      scrollTrigger:{
        scroller:'#main',
        start:'top 80%',
        end:'bottom top',
        trigger:`#secondline>span`,
        scrub:0.5,
      },
      stagger:0.2
    })
...
canvas()
function page4anim(){
  let mydiv2 = document.getElementById('myline');
  let mydivhtml2 = document.getElementById('myline').innerHTML;
  let myarr2 = mydivhtml2.split(' ');
  let newarr2 = myarr2.map((element,index)=>`<span class='animated'>${element}</span>`);
  mydiv2.innerHTML = newarr2.join('\n')
    gsap.to(`#myline>span`,{
      color:'white',
      scrollTrigger:{
        scroller:'#main',
...
canvas1()
function page6anim(){
  let mydiv2 = document.getElementById('myline2');
  let mydivhtml2 = document.getElementById('myline2').innerHTML;
  let myarr2 = mydivhtml2.split(' ');
  let newarr2 = myarr2.map((element,index)=>`<span class='animated'>${element}</span>`);
  mydiv2.innerHTML = newarr2.join('\n')
    gsap.to(`#myline2>span`,{
      color:'white',
      scrollTrigger:{
        scroller:'#main',
        trigger:`#myline2>span`,
        start:'top 80%',
        scrub:0.5,
      },
      stagger:0.2
